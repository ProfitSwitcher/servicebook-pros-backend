...
// Analytics
// Returns overall metrics about customers, jobs and invoices
export async function getAnalyticsSummary() {
  return request('/analytics/summary');
}

// Returns metrics for a specific customer
export async function getCustomerAnalytics(customerId) {
  return request(`/analytics/customer/${customerId}`);
}

// Returns predicted next month's revenue
export async function getRevenuePrediction() {
  return request('/analytics/predict');
}